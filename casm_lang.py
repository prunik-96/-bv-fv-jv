# casm_lang.py
# -----------------------------------------
# CAsm + мини-3D-движок на tkinter
#
# Новые команды языка (ставь ; в конце):
#   window <width> <height> <title_id>;
#     Пример: window 800 600 Demo;
#
#   camera <x> <y> <z>;             (установить позицию камеры, абсолютное значение)
#     Пример: camera 0 0 -5;
#
#   object <type> <name> <x> <y> <z> <size> <color_id>;
#     type: cube | sphere
#     Пример: object cube box 0 0 0 1 green;
#
#   move <name> <dx> <dy> <dz>;     (сместить объект)
#     Пример: move box 0.1 0 0;
#
#   rotate <name> <rx> <ry> <rz>;   (накопительная «логическая» ориентация; в рендере не применяется 3D-матрицей,
#                                    но поле сохраняется — можно расширить позже)
#     Пример: rotate box 10 0 0;
#
#   render;                         (перерисовать сцену)
#
# Всё остальное (int/print/while/asm) — как было.
# -----------------------------------------
